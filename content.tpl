<section >
    ...
    <video class="featured" autoplay="" loop="" style="width: 100%;">
      <source src="img/Home.webm" type="video/webm">
      <source src="img/Home.mp4" type="video/mp4">
      <source src="img/Home.ogv" type="video/ogg">
    </video>
...
<div class="greyed">
    <section id="about" class="padded-vertical-70 container text-center">
          ...
          <div class="row mar-bot40">
            <div class="col-lg-4" >
              <div class="align-center">
                <h4 class="text-bold">#featurecopy3#</h4>
                <p>#featurecopy4#
                </p>
              </div>
            </div>
            ...
            <div class="col-lg-4" >
              <div class="align-center">
                <h4 class="text-bold">#featurecopy5#</h4>
                <p>#featurecopy6#
                </p>
              </div>
            </div>
            ...
            <div class="col-lg-4" >
              <div class="align-center">
                <h4 class="text-bold">#featurecopy7#</h4>
                <p>#featurecopy8#
                </p>
              </div>
            </div>
    ...
    <section id="section-about" class="section appear clearfix">
        <div class="padded-vertical-70 container text-center">
          #featurecopy33#
        <!-- Icon Box -->
        <!-- <div class="col-lg-6 col-lg-offset-3 text-center signups">
                <div class="margin-bottom-40">
                    <h4 class="text-uppercase margin-bottom-0"><strong>Sign Up</strong> to our Newsletter!</h4>
                    <p class="lead text-muted font-alt">Get involved with our latest events and exclusive member features!</p>
                </div>
                <form id="sign-in-form">
                    <div class="form-group form-group-lg">
                        <input type="text" id="emailSigned" name="emailSigned" class="form-control bg-white margin-bottom-5" placeholder="Type your name here...">
                        <input type="text" id="emailSigned" name="emailSigned" class="form-control bg-white margin-bottom-5" placeholder="Type your e-mail address here...">
                    </div>
        ...
        <div class="row">
          <!--<div class="fullycovered container"> //-->
          <div class="col-md-12">
                <!-- <a href="http://docdro.id/nI8XPFY" target="_blank"><img src="img/blumMenu_v2.jpg"></a> -->
                  <center>
                  <div class="col-md-4">
                  <!-- <div class="halfcoveredlefta"> -->
                    #featurecopy11#
                  </div>

                  <div class="col-md-4">
                  <!-- <div class="halfcoveredmida"> -->
                    #featurecopy29#
                  </div>

                    <div class="col-md-4 ">
                    <!-- <div class="halfcoveredrighta"> -->
                      #featurecopy31#
                    </div>
                  </center>
    ...
    <!-- <section id="parallax1" class="section pad-top40 pad-bot40" data-stellar-background-ratio="0.5">
      <div class="container">
            <div class="align-center pad-top40 pad-bot40">
                <blockquote class="bigquote color-white">#featurecopy20#</blockquote>
            </div>
      </div>
    </section> -->
...
<div class="greyed">
    <section id="section-contact" class="section appear clearfix">
        <div class="section-header container section-container">
              <h2 class="section-heading animated" data-animation="bounceInUp">#featurecopy21#</h2>
        </div>

                <div class="row">

                                  <div class="high-left">#featurecopy22#</div>

                                  <div class="high-right">#featurecopy23#</div>
    ...
    <div class="google-map container"><iframe width="100%" height="500px" frameborder="0" style="border:0"
